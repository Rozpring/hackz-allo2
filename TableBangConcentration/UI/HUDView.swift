...
///
/// - Note: iOS（SwiftUI）依存のため GameCore SPM ビルドには含めない。kyiku の Xcode で実機確認する。
public struct HUDView: View {
    ...
    public init(game: GameStateManager, isHandDetected: Bool, maxPower: Float) {
        self.game = game
    ...
    public var body: some View {
        ...
        .padding()
        .allowsHitTesting(false)  // HUD はタップを奪わない（盤面タップ/操作を妨げない）
    }
